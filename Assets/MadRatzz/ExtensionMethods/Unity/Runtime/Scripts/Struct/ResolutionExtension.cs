...
namespace MadRatz.Extensions
{
	public static partial class ResolutionExtension
	{
		...
		public static Resolution With(this Resolution resolution, int? width = null, int? height = null,
		                              int? refreshRate = null)
		{
			var result = new Resolution
			{
				width = width ?? resolution.width, height = height ?? resolution.height,
				refreshRate = refreshRate ?? resolution.refreshRate
			};
			return result;
		}
	}
