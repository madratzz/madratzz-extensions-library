...
namespace MadRatz.Extensions
{
	public static partial class IDictionaryExtension
	{
		...
		public static IDictionary<TKey, TValue> Add<TKey, TValue>(this IDictionary<TKey, TValue> dictionary,
		...
		public static IDictionary<TKey, TValue> ForEach<TKey, TValue>(this IDictionary<TKey, TValue> dictionary,
		...
		public static IDictionary ForEach(this IDictionary dictionary, Func<object, bool> selector,
		...
		public static KeyValuePair<TKey, TValue>? Find<TKey, TValue>(this IDictionary<TKey, TValue> dictionary,
		                                                             Func<TKey, TValue, bool> selector)
		{
		...
		public static IDictionary<TKey, TValue> FindAll<TKey, TValue>(this IDictionary<TKey, TValue> dictionary,
		                                                              Func<TKey, TValue, bool> selector)
		{
			if (selector == null) return null;
