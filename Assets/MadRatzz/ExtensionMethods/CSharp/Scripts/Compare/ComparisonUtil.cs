...
namespace MadRatz.Extensions
{
	public static partial class ComparisonUtil
	{
		...
		public static Comparison<T> GetAscComparison<T, TValue>(params Func<T, TValue>[] keyGetters)
		...
		public static Comparison<T> GetDescComparison<T, TValue>(params Func<T, TValue>[] keyGetters)
			where TValue : IComparable<TValue>
		{
			var length = keyGetters.Length;
		...
		public static Comparison<T> GetCustomComparison<T, TValue>(params Func<T, (TValue, SortMode)>[] keyGetters)
			where TValue : IComparable<TValue>
		{
			var length = keyGetters.Length;
