...
namespace MadRatz.Extensions
{
	public static partial class BooleanExtensions
	{
		...
		public static bool And<T1, T2, T3>(this bool boolean, Func<T1, T2, T3, bool> other, T1 value1, T2 value2,
		                                   T3 value3)
		{
			return other != null && boolean && other(value1, value2, value3);
		}

		public static bool And<T1, T2, T3, T4>(this bool boolean, Func<T1, T2, T3, T4, bool> other, T1 value1,
		                                       T2 value2, T3 value3, T4 value4)
		{
			return other != null && boolean && other(value1, value2, value3, value4);
		}

		public static bool And<T1, T2, T3, T4, T5>(this bool boolean, Func<T1, T2, T3, T4, T5, bool> other, T1 value1,
		...
		public static bool Or<T1, T2, T3>(this bool boolean, Func<T1, T2, T3, bool> other, T1 value1, T2 value2,
		                                  T3 value3)
		{
			return other == null ? boolean : boolean || other(value1, value2, value3);
		}

		public static bool Or<T1, T2, T3, T4>(this bool boolean, Func<T1, T2, T3, T4, bool> other, T1 value1, T2 value2,
		                                      T3 value3, T4 value4)
		{
			return other == null ? boolean : boolean || other(value1, value2, value3, value4);
		}

		public static bool Or<T1, T2, T3, T4, T5>(this bool boolean, Func<T1, T2, T3, T4, T5, bool> other, T1 value1,
		                                          T2 value2, T3 value3, T4 value4, T5 value5)
		{
		...
		public static bool AndNot<T1, T2, T3>(this bool boolean, Func<T1, T2, T3, bool> other, T1 value1, T2 value2,
		                                      T3 value3)
		{
			return other != null && boolean && !other(value1, value2, value3);
		}

		public static bool AndNot<T1, T2, T3, T4>(this bool boolean, Func<T1, T2, T3, T4, bool> other, T1 value1,
		                                          T2 value2, T3 value3, T4 value4)
		{
			return other != null && boolean && !other(value1, value2, value3, value4);
		}

		public static bool AndNot<T1, T2, T3, T4, T5>(this bool boolean, Func<T1, T2, T3, T4, T5, bool> other,
		...
		public static bool OrNot<T1, T2, T3>(this bool boolean, Func<T1, T2, T3, bool> other, T1 value1, T2 value2,
		                                     T3 value3)
		{
			return other == null ? boolean : boolean || !other(value1, value2, value3);
		}

		public static bool OrNot<T1, T2, T3, T4>(this bool boolean, Func<T1, T2, T3, T4, bool> other, T1 value1,
		                                         T2 value2, T3 value3, T4 value4)
		{
			return other == null ? boolean : boolean || !other(value1, value2, value3, value4);
		}

		public static bool OrNot<T1, T2, T3, T4, T5>(this bool boolean, Func<T1, T2, T3, T4, T5, bool> other, T1 value1,
		                                             T2 value2, T3 value3, T4 value4, T5 value5)
		{
			return other == null ? boolean : boolean || !other(value1, value2, value3, value4, value5);
		}
