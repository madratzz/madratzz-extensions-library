...
namespace MadRatz.Extensions
{
	public static class TypeExtension
	{
		...
		{
			var result = type.IsGenericType && (typeof(List<>) == type.GetGenericTypeDefinition() ||
		...
		public static Dictionary<FieldInfo, List<T>> GetFieldsWithAttribute<T>(
			this Type type, Predicate<T> predicate = null) where T : Attribute
		{
		...
		public static Dictionary<PropertyInfo, List<T>> GetPropertiesWithAttribute<T>(
			this Type type, Predicate<T> predicate = null) where T : Attribute
		{
			var attrType = typeof(T);
		...
		public static Dictionary<MethodInfo, List<T>> GetMethodsWithAttribute<T>(
			this Type type, Predicate<T> predicate = null) where T : Attribute
		{
			var attrType = typeof(T);
