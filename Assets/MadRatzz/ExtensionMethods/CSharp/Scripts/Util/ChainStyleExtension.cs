...
namespace MadRatz.Extensions
{
	public static partial class ChainStyleExtension
	{
		...
		public static SwitchCase<TCase, TOther> Switch<TCase, TOther>(this TCase @case, Action<TOther> action)
		...
		public static SwitchCase<TCase, TOther> Switch<TInput, TCase, TOther>(
			this TInput input, Func<TInput, TCase> selector, Action<TOther> action) where TCase : IEquatable<TCase>
		{
		...
		public static SwitchCase<TCase, TOther> Case<TCase, TOther>(this SwitchCase<TCase, TOther> switchCase,
		                                                            TCase option, TOther other)
			where TCase : IEquatable<TCase>
		{
		...
		public static SwitchCase<TCase, TOther> Case<TCase, TOther>(this SwitchCase<TCase, TOther> switchCase,
		                                                            TCase option, TOther other, bool bBreak)
			where TCase : IEquatable<TCase>
		{
		...
		public static SwitchCase<TCase, TOther> Case<TCase, TOther>(this SwitchCase<TCase, TOther> switchCase,
		                                                            Predicate<TCase> predicate, TOther other)
			where TCase : IEquatable<TCase>
		{
		...
		public static SwitchCase<TCase, TOther> Case<TCase, TOther>(this SwitchCase<TCase, TOther> swichCase,
		                                                            Predicate<TCase> predicate, TOther other,
		...
		public static SwitchCase<TCase, TOther> Default<TCase, TOther>(this SwitchCase<TCase, TOther> switchCase,
		                                                               TOther other)
		{
