...
namespace MadRatz.Extensions
{
	public static partial class ActionExtension
	{
		...
		public static void Invoke<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5>[] actions, T1 t1, T2 t2, T3 t3,
		                                              T4 t4, T5 t5)
		{
			for (var i = 0; i < actions.Length; i++)
			{
		...
		public static void Invoke<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6>[] actions, T1 t1, T2 t2,
		...
		public static void Invoke<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7>[] actions, T1 t1,
		...
		public static void Invoke<T1, T2, T3, T4, T5, T6, T7, T8>(this Action<T1, T2, T3, T4, T5, T6, T7, T8>[] actions,
